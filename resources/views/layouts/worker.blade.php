...
<head>
  ...
  <title>Dashboard - Sistem RSUA</title>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <img src="{{ url('upload/admin/worker/', auth()->guard('worker')->user()->img) }}" alt="Profile" class="rounded-circle" style="height:40px;width:40px;">
            @if (auth()->guard('worker')->check())
              @php
                  $username = auth()->guard('worker')->user()->username
              @endphp
            @endif
