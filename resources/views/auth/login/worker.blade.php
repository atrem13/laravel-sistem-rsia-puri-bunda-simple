...
@section('page-content-title')
    Login to Worker Account
@endsection
@section('page-content-body')
<form method="POST" action="{{ route('auth.login.login_worker') }}" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <div class="row mb-3">
        <div class="col-md">
...
<div class="text-center my-3">
    <a class="text-muted"href="{{ route('auth.register.form_worker') }}">Register</a>
</div>
@endsection