...
<head>
  ...
  <title>Landing Sistem RSUA</title>
    ...
    <div class="container">
      <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h5 class="card-title text-center pb-0 fs-4 mb-5">Welcome to Sistem RSUA</h5>
            </div>
          </div>
          <div class="row justify-content-center">
            ...
            <div class="col-4 text-center ">
              <div class="card shadow-sm">
                <div class="card-body">
                  <a class="mt-3 btn d-block" href="{{ route('auth.login.form_worker') }}">Login Worker</a>
                </div>
              </div>
            </div>
          </div>
