...
class AdminController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        try{
            ...
            DB::commit();
            return redirect()->back()->with('result', ['success', 'Data #'.$admin->name.' Berhasil Ditambahkan.']);
    ...
    public function update(Request $request, Admin $admin) {
        ...
        try{
            ...
            DB::commit();
            return redirect()->back()->with('result', ['success', 'Data #'.$admin->name.' Berhasil Diperbaharui.']);
    ...
    public function destroy(Request $request, Admin $admin) {
        ...
        try {
            ...
            $admin->delete();
            DB::commit();
            $result = 'Data #'.$admin->name.' Berhasil Dihapus.';
